...
namespace Control_Electivas
{
    public partial class AvisosForm : Form
    {
        ...
        private void FormatearGrid()
        {
            ...
            dgvAvisos.Columns["Materia"].AutoSizeMode = DataGridViewAutoSizeColumnMode.AllCells;
            dgvAvisos.Columns["Carrera"].AutoSizeMode = DataGridViewAutoSizeColumnMode.AllCells;
        ...
        private void btnCancelar_Click(object sender, EventArgs e)
        {
            ...
            if (aviso.Estado != "Pendiente")
            {
                MessageBox.Show("Solo se pueden cancelar avisos pendientes");
                return;
            }
